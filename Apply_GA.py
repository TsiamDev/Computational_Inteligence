# -*- coding: utf-8 -*-
"""
Created on Wed Jun  1 09:41:30 2022
...
def Apply_GA():
    ...
    #for i in range(0, 10):
    pop, ones = Get_Normal_Pop(POP_SIZE, BIT_NUM, ONES_THRESH, 2500, 500)
    ...
    #while it_act < MAX_IT:
        ...
        chosen = Tournament(scores, pop, POP_SIZE)
    ...
    #get best solution 
    best_solution = scores.index(max(scores))
    p = pop[best_solution]
    
    print("Best solution count:", p.count(1))
    
    #convert best solution to words
    words = []
