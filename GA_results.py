# -*- coding: utf-8 -*-
"""
Created on Wed Jun  1 09:25:04 2022
...
from preprocessing import Preprocess_and_apply_GA
...
train_label_file = 'C:\\Users\\HomeTheater\\Desktop\\Computational_Inteligence-main\\Data\\train-label.dat'
...
#for i, (_train, _test) in enumerate(cv.split(train)):
    ...
    # n_outputs = O
    #Best val_loss So Far: 8.257484436035156
    
    #Best hyperparameter values:
    #alpha: 0.23
    #learning_rate: 0.08
    #momentum: 0.16000000000000003
    #decay: 0.03
    
    # Build model
    inputs = layers.Input(shape=(n_inputs,))
    lReLU = layers.LeakyReLU(alpha=0.23)
    ...
    opt = keras.optimizers.SGD(learning_rate=0.08, momentum=0.16, decay=0.03, nesterov=False)
