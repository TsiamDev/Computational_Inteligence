# -*- coding: utf-8 -*-
"""
Created on Sun Mar 20 08:53:43 2022
...
#for i, (_train, _test) in enumerate(cv.split(train)):
    ...
    #opt = keras.optimizers.SGD(learning_rate=0.1, momentum=0.6, decay=0.1, nesterov=False)
    #opt = keras.optimizers.SGD(learning_rate=0.1, momentum=0.6, decay=0.5, nesterov=False)
